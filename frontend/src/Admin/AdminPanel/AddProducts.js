...
useEffect(() => {
  ...
  const unitOptions = [
    ...
    ...((Array.isArray(unitData) ? unitData : [])
      .filter(el => el?.status)
      .filter(el => !((CreateProductFormik.values.unit || []).includes(el.unitName)))
      ...
      <div className='px-sm-4 px-3 mx-sm-3'>
            <div className='d-flex justify-content-between mt-sm-4 mt-3'>
                <div>
                   ...
                   <p className='ds_text ds_font ds_cursor'><Link to="/admin/Dashboard" className='sp_text_gray'>Dashboard</Link> / <span onClick={()=> navigate("/admin/product")}>Products</span> <span style={{color:'rgba(20, 20, 20, 1)'}}> / Add Products</span></p>
                </div>
            </div>
                      ...
                      <label className='ds_login_label'>Main Category</label>
                            <div className='mt-2'>
                              <CustomSelect
                                ...
                                value={CreateProductFormik?.values.mainCateId}
                                onChange={(val) => CreateProductFormik.setFieldValue('mainCateId', val)}
                      ...
                      <label className='ds_login_label'>Category</label>
                            <div className='mt-2'>
                              <CustomSelect
                                ...
                                value={CreateProductFormik?.values.cateName}
                                onChange={(val) => CreateProductFormik.setFieldValue('cateName', val)}
                      ...
                      <label className='ds_login_label'>Sub Category</label>
                            <div className='mt-2'>
                              <CustomSelect
                                ...
                                value={CreateProductFormik?.values.SubcateName}
                                onChange={(val) => CreateProductFormik.setFieldValue('SubcateName', val)}
                  ...
                  <div className="col-xl-4 col-lg-6 px-3 mt-sm-4 mt-3">
                      <div className="form-group">
                        ...
                        <div className='mt-1'>
                          <CustomSelect
                            options={sizeOptions}
                            value={CreateProductFormik?.values.sizeName}
                            onChange={(val) => CreateProductFormik.setFieldValue('sizeName', val)}
                    ...
                    <div className="form-group">
                      ...
                      <div style={{ display: 'flex', gap: '10px', alignItems: 'center', marginTop: '4px', width: '100%' }}>
                        <CustomSelect
                          ...
                          value={''}
                          onChange={(val) => {
                            if (val && !(CreateProductFormik.values.unit || []).includes(val)) {
                              CreateProductFormik.setFieldValue('unit', [...(CreateProductFormik.values.unit || []), val]);
                            }
                          }}
                      ...
                      <div className="form-group">
                        ...
                        <div className='mt-1'>
                          <CustomSelect
                            ...
                            value={CreateProductFormik?.values.stockStatus}
                            onChange={(val) => CreateProductFormik.setFieldValue('stockStatus', val)}
