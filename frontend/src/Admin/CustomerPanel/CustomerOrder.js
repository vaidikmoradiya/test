       ...
       <div className='px-sm-4 px-3 mx-sm-3 sp_height'>
              <div className='d-flex flex-wrap justify-content-between mt-sm-4 mt-3'>
                      <div>
                         ...
                         <p className='ds_text ds_font'>Dashboard<span style={{color:'rgba(20, 20, 20, 1)'}}> / Order</span></p>
                      </div>
                      <div className='d-flex'>
                         <button className='ds_order_calender position-relative'>
                           <input ref={dateRef} type="date" className='w-100 h-100' style={{border:'none'}} />
                    ...
                    <tr>
                        ...
                        <td>
                            <div className='sp_table_action d-flex'>
                                <div onClick={()=> navigate("/customer/vieworder")}><img src={eye} ></img></div>
                                <div onClick={()=> setDeletePopup(true)}><img src={print}></img></div>
                            </div>
                        </td>
                    </tr>
                    <tr>
           ...
           <div className='d-flex flex-column h-100'>
              <div className="form-group mt-2">
               ...
               <div className="form-group mt-4">
                  ...
                  <RangeSlider className="ds_range" min={MIN} max={MAX} step={STEP} value={range} onInput={(value) => setRange(value)} />
