        ...
        <div className="d-flex flex-wrap justify-content-between mt-sm-4 mt-3">
          <div>
            ...
            <p className="ds_text ds_font ds_cursor">
              Dashboard{" "}
              <span onClick={() => navigate("/admin/order")}>/ Order </span>{" "}
        ...
        <div className="row align-items-stretch">
            ...
            <div className="ds_view_box overflow-x-auto h-100">
              <div className="ds_vieworder_manage">
                <div
                  ...
                  style={{ borderBottom: "0.6px solid rgba(20, 20, 20, 0.2)" }}
                >
                  <div>
                    <p>
                      Order ID :{" "}
                      <span className="fw-bolder">#51641684166514</span>
                    </p>
                  </div>
                  <div className="d-flex">
                    <p className="mb-0 d-flex">
                      18/02/2025 <span className="ds_view_border"></span>
                    </p>
                    <p className="mb-0 d-flex ms-2">
                      3 Items<span className="ds_view_border"></span>
                    </p>
                    <p className="mb-0 d-flex ms-2">
                      Txn ID : <span className="fw-bolder ms-1"> 51684561</span>
                    </p>
                  </div>
                </div>
                        ...
                        <div className="d-flex align-items-center">
                          <div>
                            <img
                              src={pro}
                              alt=""
                              className="ds_vieworder_img"
                            />
                          </div>
                          <p className="mb-0 ms-3 ds_600">
                            Delta Omni 0.4X19 Relay Nozzle{" "}
                          </p>
                        </div>
                      </td>
          ...
          <div className="col-xl-4 col-lg-12 mt-xl-2 mt-4">
            <div className="ds_view_box h-100">
              ...
              <p className="mt-3 mb-0" style={{ color: "#14141499" }}>
                Order ID :{" "}
                <span className="ds_600" style={{ color: "#141414" }}>
                  #51641684166514
                </span>{" "}
              </p>
              <p className="mt-2 mb-0" style={{ color: "#14141499" }}>
                Order Date :{" "}
                <span className="ds_600" style={{ color: "#141414" }}>
                  18/02/2025
                </span>{" "}
              ...
              <div className="mt-4">
                <h6 className="ds_600 ds_vieworder_title mb-3">
                  Shipping Address
                </h6>
                <p style={{ fontSize: "14px" }}>
                  Ehrenkranz 13 Washington Square S, New York, Wangton Square,
                  NY 10012, USA
                </p>
                <div className="d-flex">
                  <p className="d-flex ds_600">
                    Johan Patel <span className="ds_view_border"></span>
                  </p>
              ...
              <div className="mt-3">
                ...
                <div className="d-flex justify-content-between ">
                  <p className="mb-2" style={{ color: "#14141499" }}>
                    Sub Total
                  </p>
