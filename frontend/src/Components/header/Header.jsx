...
const Header = () => {
    ...
    // Recalculate when menu data loads/changes
    useEffect(() => {
    ...
    }, [maincategoryData, categoryData, subcategoryData]);
                ...
                <div className="mv_modal_overlay">
                    <div className="mv_modal_content" style={{ maxWidth: '400px', textAlign: 'center', padding: '30px' }}>
                        <div style={{ marginBottom: '20px' }}>
                            ...
                            <p style={{ color: '#666', marginBottom: '20px' }}>Your password has been updated successfully.</p>
                        </div>
                    </div>
                </div>
            )}
